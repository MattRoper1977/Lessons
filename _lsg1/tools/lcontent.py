...
L["W3L1"] = dict(
    ...
    lead=dict(badge="Lead-in", when="Into today",
              sup="Look at the microscope. Point to the part you look through.",
              std="A microscope has two lenses, not one. Why do you think it needs both?",
              stg="A microscope multiplies two lenses together. Predict what that does to the image, and what it cannot fix."),
...
L["W3L2"] = dict(
    ...
    r=[
        dict(badge="R1", when="Last lesson",
             ...
             stg="Last lesson: explain why a bigger image is not automatically a more useful one."),
        dict(badge="R2", when="What you already know",
    ...
    lead=dict(badge="Lead-in", when="Into today",
              ...
              stg="Given a drawing and the real size, predict which calculation gives magnification."),
...
L["W3L3"] = dict(
    ...
    r=[
        ...
        dict(badge="R2", when="Week 3 · lesson 1",
             ...
             stg="Explain why raising magnification past a microscope's resolution adds no new information."),
...
L["W4L1"] = dict(
    ...
    r=[
        ...
        dict(badge="R2", when="Week 3",
             ...
             stg="Week 3: explain why a light microscope has a limit that magnification cannot get past."),
...
L["W4L2"] = dict(
    ...
    r=[
        ...
        dict(badge="R3", when="Week 3",
             ...
             std="Week 3: what is the difference between magnification and resolution?",
             stg="Week 3: explain why resolution, not magnification, decides what detail you can report."),
    ],
    lead=dict(badge="Lead-in", when="Into today",
...
L["W5L1"] = dict(
    ...
    r=[
        dict(badge="R1", when="Last lesson",
             ...
             stg="Last lesson: explain how direction, gradient and adaptation combine in one answer."),
...
L["W5L2"] = dict(
    ...
    r=[
        dict(badge="R1", when="Last lesson",
             ...
             stg="Last lesson: explain osmosis using the words partially permeable and concentration."),
        dict(badge="R2", when="Week 4",
...
L["W5L3"] = dict(
    ...
    r=[
        dict(badge="R1", when="Last lesson",
             ...
             std="Last lesson you ran the osmosis practical. What did you keep the same?",
...
L["W6L3"] = dict(
    ...
    r=[
        dict(badge="R1", when="Last lesson",
             ...
             stg="Last lesson: explain how the oxygen evidence supports active transport rather than diffusion."),
...
L["W7L1"] = dict(
    ...
    r=[
        ...
        dict(badge="R2", when="Week 6",
             ...
             stg="Week 6: explain the evidence that links mineral uptake to respiration."),
        dict(badge="R3", when="Weeks 3–5",
             ...
             stg="Weeks 3–5: explain how microscopy made the transport explanations possible at all."),
    ],
    lead=dict(badge="Lead-in", when="Into today",
...
L["W7L2"] = dict(
    ...
    lead=dict(badge="Lead-in", when="Into today",
              ...
              std="Describe and explain are different instructions. What does each one ask you to do?",
...
L["W7L3"] = dict(
    ...
    r=[
        ...
        dict(badge="R3", when="Week 6",
             sup="Point to the process that needs energy.",
             std="Week 6: compare active transport with diffusion.",
             stg="Week 6: explain how you would identify the process from unfamiliar evidence."),
    ],
    lead=dict(badge="Lead-in", when="Into today",
