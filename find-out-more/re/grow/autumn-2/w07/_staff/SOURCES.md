# GROW_RE_A2_W07 · sources and fact check

## Scheme binding

- Source: `RE_Scheme_of_Work_Autumn_2026.html`
- Source SHA256: `5a1b523738c7a9e21c7ab2a713970423b5bc4343595432ee315bb5999932e992`
- Objective: Show understanding of beliefs, festivals, belonging and respect using evidence from the term.

## Factual reading

- Chunk 1: A Church of England christening and a Humanists UK naming ceremony are distinct welcome examples. (checked against the named subject sources below).
- Chunk 2: They can both involve community while having different religious or non-religious meanings. (checked against the named subject sources below).
- Chunk 3: A comparison needs one source detail from each, not an assumed pupil view. (checked against the named subject sources below).
...
- **Humanists UK — Humanist Ceremonies** — https://humanists.uk/ceremonies/home/
