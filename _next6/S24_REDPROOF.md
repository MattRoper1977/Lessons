...
FAIL     A · confirmation block moved outside `.print-pack`
         ...
         · ../../../tmp/s24-red-v9vi0mfu/BUILD_ASDAN_A2_CON_W1_Materials_Tools_and_Safety.html | CONFIRMATION BLOCK NOT ON PAPER | 2 pages rendered, sentinel absent from PDF text
```
...
FAIL     B · print height overrides removed, `.slide` back at `height:91%`
         ...
         · ../../../tmp/s24-red-2acj8ain/PEQ_W7_What_Makes_a_Team_Effective_Features_Advantages_Challenges_LAUNCH.html | BLANK PAGE | p10 ink=0.7117% chars=0
```
