...
const [beforeReadablePath, beforeBundledPath, afterReadablePath, afterBundledPath] = process.argv.slice(2);
if (!afterBundledPath) throw new Error('usage: before-readable before-bundled after-readable after-bundled');
...
console.log('ORBITAL PAUSE PASS — old copies resume live flight as AIM; repaired copies preserve FLY and safely fall back from stale flight');
