...
(function (global) {
  ...
  A.arm = {
    ...
    css:
      '.ba-svg[data-asset="arm"] [data-part="forearm"]{transform-box:view-box;transform-origin:196px 186px}' +
      '.ba-svg[data-asset="arm"] [data-part="biceps"]{transform-box:view-box;transform-origin:88px 174px}' +
      '.ba-svg[data-asset="arm"] [data-part="triceps"]{transform-box:view-box;transform-origin:88px 198px}' +
      /* BENT — the biceps has pulled the forearm up; the triceps has let go */
      '.ba-stage[data-pose="bend"] .ba-svg[data-asset="arm"] [data-part="forearm"]{transform:rotate(-68deg)}' +
      '.ba-stage[data-pose="bend"] .ba-svg[data-asset="arm"] [data-part="biceps"]{transform:scale(.74,1.95)}' +
      '.ba-stage[data-pose="bend"] .ba-svg[data-asset="arm"] [data-part="triceps"]{transform:scale(1.06,.42)}' +
      /* STRAIGHT — the two jobs swap over */
      '.ba-stage[data-pose="straight"] .ba-svg[data-asset="arm"] [data-part="forearm"]{transform:rotate(0)}' +
      '.ba-stage[data-pose="straight"] .ba-svg[data-asset="arm"] [data-part="biceps"]{transform:scale(1.06,.42)}' +
      '.ba-stage[data-pose="straight"] .ba-svg[data-asset="arm"] [data-part="triceps"]{transform:scale(.74,1.95)}',
    svg: function () {
  ...
  A.armmodel = {
    ...
    css:
      '.ba-svg[data-asset="armmodel"] [data-part="forearm"]{transform-box:view-box;transform-origin:212px 144px}' +
      '.ba-svg[data-asset="armmodel"] .slack{opacity:0;transition:opacity .45s}' +
      '.ba-svg[data-asset="armmodel"] .taut{opacity:1;transition:opacity .45s}' +
      '.ba-stage[data-pose="bend"] .ba-svg[data-asset="armmodel"] [data-part="forearm"]{transform:rotate(-70deg)}' +
      '.ba-stage[data-pose="bend"] .ba-svg[data-asset="armmodel"] [data-part="bandbottom"] .taut{opacity:0}' +
      '.ba-stage[data-pose="bend"] .ba-svg[data-asset="armmodel"] [data-part="bandbottom"] .slack{opacity:1}' +
      '.ba-stage[data-pose="straight"] .ba-svg[data-asset="armmodel"] [data-part="forearm"]{transform:rotate(0)}' +
      '.ba-stage[data-pose="straight"] .ba-svg[data-asset="armmodel"] [data-part="bandtop"] .taut{opacity:0}' +
      '.ba-stage[data-pose="straight"] .ba-svg[data-asset="armmodel"] [data-part="bandtop"] .slack{opacity:1}',
    svg: function () {
  ...
  A.pullpush = {
    ...
    css:
      '.ba-svg[data-asset="pullpush"] [data-part="lever"]{transform-box:view-box;transform-origin:296px 230px}' +
      '.ba-svg[data-asset="pullpush"] [data-part="hand"]{transform-box:view-box;transform-origin:70px 112px}' +
      '.ba-svg[data-asset="pullpush"] .buckle{opacity:0;transition:opacity .4s}' +
      '.ba-stage[data-pose="pull"] .ba-svg[data-asset="pullpush"] [data-part="lever"]{transform:rotate(-32deg)}' +
      '.ba-stage[data-pose="pull"] .ba-svg[data-asset="pullpush"] [data-part="hand"]{transform:translateX(-30px)}' +
      '.ba-stage[data-pose="push"] .ba-svg[data-asset="pullpush"] [data-part="lever"]{transform:rotate(0)}' +
      '.ba-stage[data-pose="push"] .ba-svg[data-asset="pullpush"] [data-part="hand"]{transform:translateX(92px)}' +
      '.ba-stage[data-pose="push"] .ba-svg[data-asset="pullpush"] [data-part="string"] .straight{opacity:0}' +
      '.ba-stage[data-pose="push"] .ba-svg[data-asset="pullpush"] [data-part="string"] .buckle{opacity:1}',
    svg: function () {
      return g('stand', SKIN,
