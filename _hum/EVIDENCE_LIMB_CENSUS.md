...
| BUILD_HUM_W3_Places_In_My_Community.html | BUILD | declared cell | the David cover pack pins this route by digest and nothing re-stamps it |
| BUILD_HUM_W4_Then_And_Now.html | BUILD | declared cell | the David cover pack pins this route by digest and nothing re-stamps it |
| BUILD_HUM_W5_Same_And_Different.html | BUILD | declared cell | the David cover pack pins this route by digest and nothing re-stamps it |
| BUILD_HUM_W6_Our_Class_Map.html | BUILD | declared cell | the David cover pack pins this route by digest and nothing re-stamps it |
| BUILD_HUM_W7_A_place_in_the_group_Classic.html | BUILD | — | the deck carries no lesson-config, so it declares nothing |
| BUILD_HUM_W7_Groups_We_Belong_To.html | BUILD | declared cell | the David cover pack pins this route by digest and nothing re-stamps it |
...
| GROW_HUM_W3_Why_People_Moved_And_What_Changed.html | GROW | declared cell | the David cover pack pins this route by digest and nothing re-stamps it |
| GROW_HUM_W4_Diverse_British_History.html | GROW | declared cell | the David cover pack pins this route by digest and nothing re-stamps it |
| GROW_HUM_W5_Was_It_Significant.html | GROW | declared cell | the David cover pack pins this route by digest and nothing re-stamps it |
| GROW_HUM_W6_Planning_An_Account.html | GROW | declared cell | the David cover pack pins this route by digest and nothing re-stamps it |
| GROW_HUM_W7_Writing_And_Marking_The_Account.html | GROW | declared cell | the David cover pack pins this route by digest and nothing re-stamps it |
...
| LAUNCH_HUM_W3_Evaluating_A_Digital_Archive_Source.html | LAUNCH | declared cell | the David cover pack pins this route by digest and nothing re-stamps it |
| LAUNCH_HUM_W4_A_Timeline_Of_Twentieth_Century_Britain.html | LAUNCH | declared cell | the David cover pack pins this route by digest and nothing re-stamps it |
| LAUNCH_HUM_W5_Who_Shaped_Britain.html | LAUNCH | declared cell | the David cover pack pins this route by digest and nothing re-stamps it |
| LAUNCH_HUM_W6_A_Structured_Account_From_Evidence.html | LAUNCH | declared cell | the David cover pack pins this route by digest and nothing re-stamps it |
| LAUNCH_HUM_W7_Source_Based_Assessment.html | LAUNCH | declared cell | the David cover pack pins this route by digest and nothing re-stamps it |
