...
# ORDER HUM-T · HUM-T batch 4 BUILD: this batch's transplanted decks, each stage carrying the
# science exemplar's loop panel. One transaction, derived and written by
# tools/hum/admit_transaction.py. Every member also carries a CATALOGUE_PINS
# admission, which replacement_errors cross-checks.
HUM_T_BATCH_4_BUILD_REVIEW_BASE = 'ae32def62c33de971511ff966284958812d6e2fa'
...
REPLACEMENT_TRANSACTIONS = {
    ...
    'HUM-T batch 4 BUILD': (HUM_T_BATCH_4_BUILD_REVIEW_BASE, HUM_T_BATCH_4_BUILD_REPLACEMENTS),
