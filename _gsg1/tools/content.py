...
L["W5B"] = dict(
    ...
    r=[
        dict(badge="R1", when="Last lesson",
             ...
             std="Last lesson you named what to change, what to measure and what to keep the same. Name each for our test.",
...
L["W6A"] = dict(
    ...
    r=[
        dict(badge="R1", when="Last lesson",
             ...
             stg="Last lesson: explain how repeats changed how much you trusted the conclusion."),
...
L["W6B"] = dict(
    ...
    r=[
        dict(badge="R1", when="Last lesson",
             ...
             stg="Last lesson: explain what keeps a planet in orbit instead of moving in a straight line."),
        dict(badge="R2", when="Week 5",
             sup="Say the one thing we change in a fair test.",
...
L["W7A"] = dict(
    ...
    r=[
        dict(badge="R1", when="Last lesson",
             ...
             std="Last lesson you built a model. Name one thing it showed well and one it could not show.",
