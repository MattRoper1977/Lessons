/* ============================================================================
   GROW ANIMATION FRAMEWORK · Phase 2 — BIOLOGY: ANIMALS & CLASSIFICATION
   ---------------------------------------------------------------------------
   Thirteen animals, each layered so the backbone (or the absence of one) can be
   revealed on its own: fish, human, snake, bird, dog, frog, crab, spider, worm,
   snail, jellyfish, beetle, octopus.

   These assets began life in build-anim/bio-svg.js for the BUILD pathway. They
   are ported here unchanged in substance so that BUILD and GROW share ONE
   engine and ONE asset registry — a fix to a motion, a script or a shape is now
   made once and reaches both suites. build-anim/compat.js keeps the existing
   BUILD lesson markup working against this, so no BUILD lesson had to be
   rewritten to get here.

   Every asset carries `kind` ('vertebrate' | 'invertebrate') alongside the
   usual @teach and @reveal scripts, so the classification activities can ask
   the library rather than hard-coding an answer key:

     GrowSVG.list('vertebrates')      -> ['fish', 'human', 'snake', …]
     GrowSVG.asset('crab').kind       -> 'invertebrate'
...
(function (global) {
  ...
  /* ---------------------------------------------------------------- FISH */
  A.fish = {
    title: 'Fish', kind: 'vertebrate', tags: ['biology', 'animals', 'classification', 'vertebrates'],
  ...
  /* --------------------------------------------------------------- HUMAN */
  A.human = {
    title: 'Human', kind: 'vertebrate', tags: ['biology', 'animals', 'classification', 'vertebrates'],
  ...
  /* --------------------------------------------------------------- SNAKE */
  A.snake = {
    title: 'Snake', kind: 'vertebrate', tags: ['biology', 'animals', 'classification', 'vertebrates'],
  ...
  /* ---------------------------------------------------------------- BIRD */
  A.bird = {
    title: 'Bird', kind: 'vertebrate', tags: ['biology', 'animals', 'classification', 'vertebrates'],
  ...
  /* ----------------------------------------------------------- DOG (MAMMAL) */
  A.dog = {
    title: 'Dog', kind: 'vertebrate', tags: ['biology', 'animals', 'classification', 'vertebrates'],
  ...
  /* ---------------------------------------------------------------- FROG */
  A.frog = {
    title: 'Frog', kind: 'vertebrate', tags: ['biology', 'animals', 'classification', 'vertebrates'],
  ...
  /* ---------------------------------------------------------------- CRAB */
  A.crab = {
    title: 'Crab', kind: 'invertebrate', tags: ['biology', 'animals', 'classification', 'invertebrates'],
  ...
  /* -------------------------------------------------------------- SPIDER */
  A.spider = {
    title: 'Spider', kind: 'invertebrate', tags: ['biology', 'animals', 'classification', 'invertebrates'],
  ...
  /* --------------------------------------------------------------- WORM */
  A.worm = {
    title: 'Earthworm', kind: 'invertebrate', tags: ['biology', 'animals', 'classification', 'invertebrates'],
  ...
  /* --------------------------------------------------------------- SNAIL */
  A.snail = {
    title: 'Snail', kind: 'invertebrate', tags: ['biology', 'animals', 'classification', 'invertebrates'],
  ...
  /* ----------------------------------------------------------- JELLYFISH */
  A.jellyfish = {
    title: 'Jellyfish', kind: 'invertebrate', tags: ['biology', 'animals', 'classification', 'invertebrates'],
  ...
  /* -------------------------------------------------------------- BEETLE */
  A.beetle = {
    title: 'Beetle', kind: 'invertebrate', tags: ['biology', 'animals', 'classification', 'invertebrates'],
  ...
  /* ------------------------------------------------------------- OCTOPUS */
  A.octopus = {
    title: 'Octopus', kind: 'invertebrate', tags: ['biology', 'animals', 'classification', 'invertebrates'],
  ...
  /* One registry for both suites. GrowSVG.render() supplies the <svg> wrapper
     and the zoom layer, so each asset only ever describes its own layers. */
  S.register(A);
