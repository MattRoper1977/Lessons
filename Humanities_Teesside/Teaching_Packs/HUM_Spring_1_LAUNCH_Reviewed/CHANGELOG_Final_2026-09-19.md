...
Class A (mechanical) fixes applied by _passhumd5/apply_proof.py from replacements.json: **6 edits in 6 files** (house spellings, broken joins after "means", missing spaces after punctuation, doubled full stops, DOCX heading punctuation restored). Meaning-bearing items are ledgered in _passhumd5/PROOF_LEDGER.md, not changed.
