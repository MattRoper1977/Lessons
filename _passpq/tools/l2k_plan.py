...
DERIVATION = (
    ...
    "as to its own ASDAN short course was NOT derivable from the repo and was settled by OWNER "
    "RULING (2026-08-22): all six. Measured band + ruling, never a pure repo measurement. "
    "GROW's ASDAN row is empty 8/8 weeks; LAUNCH's eight planners "
