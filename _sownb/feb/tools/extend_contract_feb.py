#!/usr/bin/env python3
"""Append proved FEB destination-family rows and freeze FEB g16/g19 inputs.
...
TOKENS = ROOT / "_sownb/G19_TOKEN_OWNERSHIP_FEB.json"
BASE_DENOMS = ROOT / "_sownb/G16_DENOMINATORS_RSH3.json"
BASE_TOKENS = ROOT / "_sownb/G19_TOKEN_OWNERSHIP.json"
EVIDENCE = ROOT / "_sownb/feb/CONTRACT_EXTENSION.json"
UNPROVEN_ADDENDUM = ROOT / "_sownb/feb/UNPROVEN_FEB.md"
...
FAMILIES = {
    ...
    "GROW Humanities": {
        "slug": "grow-humanities",
        "lesson": "Humanities_Teesside/GROW_W9-W14_2026-27/GROW_HUM_W14_Map_and_Belonging_Challenge_OUTSTANDING_V3_1.html",
        "start": "Humanities_Teesside/GROW_W9-W14_2026-27/START_HERE_GROW_HUMANITIES_W9-W14.html",
        "pack": "Humanities_Teesside/GROW_W9-W14_2026-27",
        "home": 'href="../../index.html"',
        "tokens": {
            "--bg": "#141C24", "--panel": "#202D37", "--panel2": "#283743",
            "--text": "#F2EFE5", "--muted": "#C8CECA", "--steel": "#5B91A5",
            "--oxide": "#D1673D", "--teal": "#2BA193", "--gold": "#DFAD3E",
            "--violet": "#8B6CC7", "--line": "#42515d", "--paper": "#fff",
            "--ink": "#172334", "--danger": "#b93f4b",
        },
        "controls": ["TA brief", "Read response", "Sources", "Display / print", "Calm mode", "Previous", "Next"],
        "structures": [".lundy", ".ladder", ".ta-card", ".chips", ".hero-visual", ".prog"],
        "tiers": [("route-s", ".route.s"), ("route-m", ".route.m"), ("route-h", ".route.h")],
        "labels": ["◆ Supported", "▲ Standard", "★ Stretch"],
        "print": [".printpack", ".proute"],
        "start_tokens": ["--bg", "--steel"],
        "start_selectors": [".grid", ".week"],
        "start_name": "START_HERE_GROW_HUMANITIES_W9-W14.html",
        "manifest": "manifest-v3.1.json",
        "checksums": "SHA256SUMS.txt",
    },
    "LAUNCH Humanities": {
        "slug": "launch-humanities",
        "lesson": "Humanities_Teesside/LAUNCH_W9-W14_2026-27/LAUNCH_HUM_W14_Fieldwork_Enquiry_Write_Up.html",
        "start": "Humanities_Teesside/LAUNCH_W9-W14_2026-27/START_HERE.html",
        "pack": "Humanities_Teesside/LAUNCH_W9-W14_2026-27",
        "home": 'href="../../index.html"',
        "tokens": {
            "--bg": "#141C24", "--panel": "#202D37", "--panel2": "#283743",
            "--text": "#F2EFE5", "--muted": "#C8CECA", "--steel": "#5B91A5",
            "--oxide": "#D1673D", "--teal": "#2BA193", "--gold": "#DFAD3E",
            "--violet": "#8B6CC7", "--line": "#42515d", "--paper": "#fff", "--ink": "#172334",
        },
        "controls": ["TA Brief", "Read Response", "Source/Data", "Tools", "Calm mode", "Previous", "Next"],
        "structures": [".lundy", ".ladder", ".ta-card", ".drawer", ".modal", ".chips", ".hero-visual", ".prog"],
        "tiers": [("route-s", ".route.s"), ("route-m", ".route.m"), ("route-h", ".route.h")],
        "labels": ["◆ Supported", "▲ Standard", "★ Stretch"],
        "print": [".printpack", ".proute"],
        "start_tokens": ["--bg", "--steel"],
        "start_selectors": [".grid", ".card"],
        "start_name": "START_HERE.html",
        "checksums": "SHA256SUMS.txt",
    },
}
...
def build_rows() -> tuple[list[dict], list[dict[str, str]]]:
    ...
    for family, cfg in FAMILIES.items():
        ...
        out.append(row(f"pack.{slug}.manifest", family, "pack", "visible-string", manifest_name, "required filename", checksum_rel))
        ...
        out.append(row(f"pack.{slug}.checksums", family, "pack", "visible-string", cfg["checksums"], "required filename", checksum_rel, manifest_name))
...
def token_config() -> dict:
    families = json.loads(BASE_TOKENS.read_text(encoding="utf-8"))["families"]
    for family, cfg in FAMILIES.items():
    ...
    return {
        "schema": "feb-g19-token-ownership-v1",
...
def main() -> int:
    ...
    base_families = json.loads(BASE_DENOMS.read_text(encoding="utf-8"))["families"]
    ...
    denominators = {
        "schema": "feb-g16-denominators-v1", "contractSha256": sha(CONTRACT),
        "contractRowCount": len(reread["rows"]), "frozenAtAnchor": "4916fe9511e24e1f5541e7454f3d2e9d4bac5f75",
        "families": families, "rule": "Frozen before the first FEB candidate measurement; no drift within the run.",
    }
    ...
    result = {
        "status": "PASS", "route": "ABSENT / exact recovery plus explicit FEB extension",
