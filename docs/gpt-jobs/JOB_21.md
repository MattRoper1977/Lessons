# GPT JOB 21 — SCI_G_W11B_Climate_Action_Do
...
| field | value |
|---|---|
| served deck | `Science_Teesside/Grow/W8-W13_2026-27/SCI_G_W11B_Climate_Action_Do.html` |
| why held | body provenance: the Do deck carries its Explore partner's lesson; the Do lesson is absent (_sx3/HELD.md §D) |
| pathway | GROW |
| SoW cell | Aut2·W4 · `'GROW Weekly - Autumn'!C42` (the pack manifest / spine audit cites this cell) |
| learning outcome (workbook, verbatim) | Describe causes and effects of global warming and how to reduce our impact. |
