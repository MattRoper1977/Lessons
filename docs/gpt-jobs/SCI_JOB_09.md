...
| field | value |
|---|---|
| served deck | `Science_Teesside/Build/SCI_B_W3_Backbones.html` |
| why held | Original Science stage contract: supply defect, queued for re-authoring (_sx3/HELD.md §B, ORDER SX3-M2 §4) |
| pathway | BUILD |
| SoW cell | Aut1·W3 · `'BUILD Weekly - Autumn'!C34` (the pack manifest / spine audit cites this cell) |
| learning outcome (workbook, verbatim) | Compare animals with and without a backbone (vertebrates and invertebrates). |
