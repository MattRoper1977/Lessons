# SCI_JOB_12 — SCI_B_W6_Balanced_Plate
...
| field | value |
|---|---|
| served deck | `Science_Teesside/Build/SCI_B_W6_Balanced_Plate.html` |
| why held | Original Science stage contract: supply defect, queued for re-authoring (_sx3/HELD.md §B, ORDER SX3-M2 §4) |
| pathway | BUILD |
| SoW cell | Aut1·W6 · `'BUILD Weekly - Autumn'!C37` (the pack manifest / spine audit cites this cell) |
| learning outcome (workbook, verbatim) | Sort foods into groups and describe a balanced diet (links PSHE / Foodwise). |
