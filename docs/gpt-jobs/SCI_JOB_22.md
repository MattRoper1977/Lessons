...
| field | value |
|---|---|
| served deck | `Science_Teesside/Grow/W8-W13_2026-27/SCI_G_W12B_Science_Answer_Lab_Do.html` |
...
- The SoW cell above: the lesson's stated outcome equals the workbook cell, and its term·week is Aut2·W5.
