# GPT JOB 17 — SCI_G_W6_Earth_And_Planets
...
| field | value |
|---|---|
| served deck | `Science_Teesside/Grow/SCI_G_W6_Earth_And_Planets.html` |
| why held | Original Science stage contract: supply defect, queued for re-authoring (_sx3/HELD.md §B, ORDER SX3-M2 §4) |
| pathway | GROW |
| SoW cell | Aut1·W6 · `'GROW Weekly - Autumn'!C37` (the pack manifest / spine audit cites this cell) |
| learning outcome (workbook, verbatim) | Describe the movement of the Earth and other planets around the Sun. |
...
- The SoW cell above: the lesson's stated outcome equals the workbook cell, and its term·week is Aut1·W6.
