...
<main id="main"><section class="hero"><div class="hero-in"><p class="eyebrow">BUILD · GROW · LAUNCH</p><h1>Humanities <span>by term</span></h1><p class="lead">Choose your pathway and term, then choose a teaching version. Browse current Humanities and RE sequences, teaching alternatives, schemes of work and classroom support.</p></div></section>
<section class="catalogue-intro" aria-label="Choose a teaching version"><div class="catalogue-links"><a href="?term=Aut1" data-shortcut="autumn">Browse Autumn 1</a><a href="?style=full-lundy" data-shortcut="full-lundy">Browse full Lundy Loop versions</a><a href="../">All subjects at the Lesson Hub →</a></div><p>Full Lundy Loop versions repeat Space, Voice, Audience and Influence prompts through the lesson. Current and earlier teaching series remain available alongside them.</p><p>Term labels follow the evidence in each resource. Where a reliable term is not recorded, the resource remains under “Term not specified”.</p><p>These are browser lessons and teaching references. David’s editable PowerPoint, Word and PDF cover packs are separate downloads.</p></section>
