...
<section class="catalogue-intro" aria-label="Choose a teaching version"><div class="catalogue-links"><a href="?term=Aut1" data-shortcut="autumn">Browse Autumn 1</a><a href="?style=full-lundy" data-shortcut="full-lundy">Browse full Lundy Loop versions</a><a href="../">All subjects at the Lesson Hub →</a></div><p>Full Lundy Loop versions repeat Space, Voice, Audience and Influence prompts through the lesson. Current and earlier teaching series remain available alongside them.</p><p>Term labels follow the evidence in each resource. Where a reliable term is not recorded, the resource remains under “Term not specified”.</p><p><a href="David_Cover_Autumn1_W3-W7/index.html"><strong>Open David’s Autumn 1 cover lessons and downloads</strong></a> · 25 classroom sessions with editable slides, pupil worksheets and teacher answers.</p></section>
