...
<main id="main"><section class="hero"><div class="hero-in"><p class="eyebrow">BUILD · GROW · LAUNCH</p><h1>Science <span>by term</span></h1><p class="lead">Choose your pathway and term, then choose a teaching version. The recommended LAUNCH Weeks 3–7 lessons bring the cover pack into the familiar classroom slides.</p></div></section>
