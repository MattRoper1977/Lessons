...
<body class="{H(lane.lower())}"><a class="skip" href="#main">Skip to the lesson</a><header class="site-header"><div class="wrap topbar"><a class="brand" href="../../index.html?subject=Humanities%20%26%20RE">Made by Matt <span>Humanities &amp; RE</span></a><nav aria-label="Main navigation"><a href="index.html">David’s cover lessons</a><a href="../../index.html?subject=Humanities%20%26%20RE">Lesson hub</a></nav></div></header>'''
...
<main id="main" class="wrap"><section class="lesson-intro"><p class="eyebrow">{H(c['lane'])} pathway · {H(c['subject'])} · Autumn 1 · Week {c['week']}</p><h1>{H(c['title'])}</h1><p>David’s cover version · 40 minutes</p><p class="small">{H(c['slot'])}. Match the week to the school calendar before teaching.</p>{integrated}<nav class="week-nav" aria-label="Choose a week">{adjacent}</nav><div class="downloads"><a class="button" href="{H(paths['pupil'])}">Pupil sheets PDF</a><a class="button secondary" href="{H(paths['slides'])}" download>Editable PowerPoint</a><a class="button secondary" href="{H(paths['teacher'])}">Teacher plan &amp; answers PDF</a></div></section>
