...
for(const value of [null,[],{}, {...seed,v:4},{...seed,xp:null},{...seed,team:'wrong'},{...seed,settings:null},JSON.parse(JSON.stringify(seed).replace('"dups":{}','"dups":{"__proto__":{"bad":true}}'))]){
...
const unconfirmed=storage();unconfirmed.setItem=()=>{throw Error('quota')};unconfirmed.removeItem=()=>{throw Error('denied rollback')};
